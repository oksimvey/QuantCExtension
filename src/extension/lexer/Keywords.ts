...
export const KEYWORDS = new Set([
  "function", "return", "if", "else", "while", "for", "true", "false", "continue", "break",
  "unsigned", "switch", "case", "default", "public", "mutable", "constexpr", "abstract", "class",
  "private", "const", "global", "local", "this", "new", "try", "wait", "await", "throw", "catch",
  "null", "super", "instanceof", "and", "or", "not", "delete", "extends", "pointer", "override",
  "address", "pointing", "reference", "enum", "task", "auto", "import"
]);

export const TYPES = new Set([
  "byte", "short", "int", "long", "ubyte", "ushort", "uint", "ulong", "float", "double", "char",
  "string", "boolean", "void", "Array", "List", "HashMap", "Pointer", "UniquePointer", "SharedPointer",
  "Reference"
]);

export const BUILTINS = new Map<string, { signature: string; documentation: string }>([
...
export function registerCustomOperator(symbol: string): void { if (symbol) custom.add(symbol); }
export function getCustomOperators(): string[] { return [...custom].sort((a, b) => b.length - a.length); }
export function classifyIdentifier(value: string): TokenType {
  if (KEYWORDS.has(value)) return TokenType.Keyword;
  if (TYPES.has(value)) return TokenType.Type;
